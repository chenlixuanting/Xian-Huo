...
import cn.edu.guet.xianhuo.base.wrapper.PhotoWrapper;
...
public class GoodsInfoFragment extends BaseFragment {
    ...
    CircleIndicator circleIndicator; // ViewPager的圆点指示器
    ...
    TextView tvMarketPrice; // 商场价格
    @BindView(R.id.button_favorite)
    ImageButton btnFavorite; // 收藏
